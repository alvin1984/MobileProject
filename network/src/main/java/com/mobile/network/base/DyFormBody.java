...
public class DyFormBody extends RequestBody {
    ...
    DyFormBody(List<String> encodedNames, List<String> encodedValues) {
        this.encodedNames = Util.immutableList(encodedNames);
        this.encodedValues = Util.immutableList(encodedValues);
    }

    public DyFormBody addParam(String name,String value){
        encodedNames.add(canonicalize(name, FORM_ENCODE_SET, false, false, true, true));
        encodedValues.add(canonicalize(value, FORM_ENCODE_SET, false, false, true, true));
        return this;
    }
    ...
    public static final class Builder {
        ...
        public DyFormBody.Builder add(String name, String value) {
        ...
        public DyFormBody.Builder addEncoded(String name, String value) {
        ...
        public DyFormBody build() {
            return new DyFormBody(names, values);
        }

    }

    private String percentDecode(String encoded, boolean plusIsSpace) {
        return percentDecode(encoded, 0, encoded.length(), plusIsSpace);
    }
    private String percentDecode(String encoded, int pos, int limit, boolean plusIsSpace) {
    ...
    private void percentDecode(Buffer out, String encoded, int pos, int limit, boolean plusIsSpace) {
        int codePoint;
    ...
    private static String canonicalize(String input, String encodeSet, boolean alreadyEncoded, boolean strict,

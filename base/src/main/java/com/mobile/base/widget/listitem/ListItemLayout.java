package com.mobile.base.widget.listitem;
...
//        setBackgroundResource(outValue.resourceId);
        ...
        inflater.inflate(R.layout.base_library_list_item_layout, this);
    ...
    private void initViews() {
        mContainerLayout = (RelativeLayout) findViewById(R.id.base_lib_list_item_container);
        mListItemLeftIcon = (ImageView) findViewById(R.id.base_lib_list_item_left_icon);
        mListItemTitle = (TextView) findViewById(R.id.list_item_title);
        mListItemArrow = (ImageView) findViewById(R.id.base_lib_list_item_arrow);
        mListItemContent = (TextView) findViewById(R.id.base_lib_list_item_content);
        mListItemRightIcon = (ImageView) findViewById(R.id.base_lib_list_item_count_icon);

...
public class BaseDialog extends Dialog implements View.OnClickListener,DialogInterface.OnDismissListener {
    ...
    public BaseDialog(Context context) {
        super(context, com.mobile.base.R.style.Dialog_Fullscreen);
        mContext = context;
    ...
    private void initView() {
        View child = getLayoutInflater().inflate(R.layout.base_library_dialog_base, null, false);
        setContentView(child);
        mContainer = (FrameLayout) findViewById(R.id.base_lib_fl_container);
        mBtnPanel = (FrameLayout) findViewById(R.id.base_lib_fl_btn_panel);
        closeIV = (ImageView) findViewById(R.id.base_lib_iv_close);
    ...
    public BaseDialog setDialogSize(float widthDP,float heightDP){
        Window dialogWindow = getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = DensityUtils.dp2px(getContext(),widthDP);
        lp.height = DensityUtils.dp2px(getContext(),heightDP);
        dialogWindow.setAttributes(lp);
        return this;
    }
    ...
    public BaseDialog setViewOnClickListener(int viewId, final OnClickListener listener) {
        findViewById(viewId).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                listener.onClick(BaseDialog.this,view.getId());
            }
        });
        return this;
    }
    ...
    public BaseDialog setBtnPanelView(int layoutId, OnClickListener listener) {
        ...
        mContainer.setBackgroundResource(R.drawable.base_library_dialog_base_top_shape);
        return this;
    }
